...
| P6-04  | Active   | P6-03        | 双浏览器完整比赛体验验收                                        | 三 stage、winner、领奖台、rematch、console 与视觉检查通过       |
