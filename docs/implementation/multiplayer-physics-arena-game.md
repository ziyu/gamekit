...
| P4-01  | Active   | P3-04        | Course 编译器、共享 Physics/Nav/Presentation projection         | 相同 definition version 生成一致 stable ids 与空间事实          |
