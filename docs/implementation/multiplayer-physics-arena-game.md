...
| P6-02  | Active   | P6-01        | Audio、VFX、telegraph 与 playing/spectator camera               | 并发有界、镜头不写回 simulation、关键信息可读                   |
