...
| P3：道具与物理战斗               | Active   | Item runtime/DataType、pickup/carry/use/throw、Combat/GAS、KO credit              | 2 client 争抢同一道具；无重复消费/命中             |
...
| P3-04  | Active   | P3-03        | 道具预测、effect journal 与 fault matrix                        | loss/duplicate/gap 下无重复消费、命中、cue 或幽灵 body          |
