...
| P5-03  | Active   | P5-02        | Recast route、local steering、hazard timing 与错峰 scheduler    | path stale/stuck/stage change 可恢复；无同帧全量重评尖峰        |
