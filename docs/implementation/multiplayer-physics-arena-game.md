...
| P2-02  | Active   | P2-01        | 排名、晋级、KO/assist、timeout 与稳定 tie-break                 | deterministic headless ranking fixtures                         |
