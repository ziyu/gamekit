...
| P3-02  | Active   | P3-01        | stable target、pickup arbitration、carry、drop/throw Physics    | 两客户端同 tick 争抢只产生一个 owner；generation 稳定           |
