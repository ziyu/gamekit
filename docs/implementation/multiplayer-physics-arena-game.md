...
| P5-02  | Active   | P5-01        | Utility goal、interruptible task 与共享 character intent        | advance/survive/item/attack/escape fixtures 可确定重放          |
